"""
Отвечпет за сбор каналов той или иной назначении
"""
...
async def reload_not_configured_channels_list():
    ...
    for file_index,info_file in enumerate(Info_files):
        ...
        if not main_signal_exist:
            # print('\nnot_configured_channels DATA -->', info_file)
...
async def channels_list_paginator(
    ...
    channel_list_message = f'{"Пожалуйста выбирите число канала про которого хотите взять данные:" if first_time else ""}\n\n'
